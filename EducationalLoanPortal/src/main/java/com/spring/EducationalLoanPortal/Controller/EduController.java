package com.spring.EducationalLoanPortal.Controller;
...
import com.spring.EducationalLoanPortal.Service.EduService;
...
public class EduController {
	...
	public String deleteD(@PathVariable("cpas") int password)
	{
